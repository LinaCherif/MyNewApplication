...
public class CosmeticDetailsActivity extends AppCompatActivity {
    ...
    {  String saveCurrentDate, saveCurrentTime;
        ...
        cartListRef.child("User View").child(Prevalent.currentOnlineUser.getPhone())
                .child("Cosmétiques").child(productID)
                        ...
                        { cartListRef.child("Admin View").child(Prevalent.currentOnlineUser.getPhone())
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful())
                                        {
                                            Toast.makeText(CosmeticDetailsActivity.this,"Ajouté au panier",Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(CosmeticDetailsActivity.this, home.class);
    ...
    private void getProductDetails(String productID) {
        DatabaseReference productRef = FirebaseDatabase.getInstance().getReference().child("Cosmétiques");
