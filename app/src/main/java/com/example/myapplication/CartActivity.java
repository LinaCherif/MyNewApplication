            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                if (datasnapshot.exists())
                {
                  ...
                  if (shippingState.equals("shipped"))
                  {
                      ...
                      Toast.makeText(CartActivity.this," you car purcahse more products one you received your first order",Toast.LENGTH_SHORT);
                    ...
                    {
                        txtTotalAmount.setText("Shipping Stqte = Not shipped");
                        reyclerView.setVisibility(View.GONE);
                        txtMsg1.setVisibility(View.VISIBLE);
                        NextProcessBtn.setVisibility(View.GONE);
                        Toast.makeText(CartActivity.this," you car purcahse more products one you received your first order",Toast.LENGTH_SHORT);
