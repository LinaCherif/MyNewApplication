...
public class VetementDetailsActivity extends AppCompatActivity {
    ...
    {  String saveCurrentDate, saveCurrentTime;
        ...
        cartListRef.child("User View").child(Prevalent.currentOnlineUser.getPhone())
                .child("Vêtements").child(productID)
                        ...
                        { cartListRef.child("Admin View").child(Prevalent.currentOnlineUser.getPhone())
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful())
                                        {
                                            Toast.makeText(VetementDetailsActivity.this,"Ajouté au panier",Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(VetementDetailsActivity.this, home.class);
    ...
    private void getProductDetails(String productID) {
        DatabaseReference productRef = FirebaseDatabase.getInstance().getReference().child("Vêtements");
