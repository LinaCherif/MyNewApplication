...
public class CartVetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            {   txtTotalAmount.setText("Prix totale = " + String.valueOf(overTotalPrice));
                Intent intent = new Intent(CartVetActivity.this , ConfirmFinalOrderActivity.class);
        ...
        FirebaseRecyclerOptions<Cart> options=
                new FirebaseRecyclerOptions.Builder<Cart>()
                        .setQuery(cartListRef.child("User View")
                                .child(Prevalent.currentOnlineUser.getPhone()).child("Vêtements"),Cart.class)
                        .build();
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int i, @NonNull final Cart model)
            {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view)
                    {
                        ...
                        AlertDialog.Builder builder= new AlertDialog.Builder(CartVetActivity.this);
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i)
                            {
                                if (i == 0)
                                {
                                    Intent intent = new Intent(CartVetActivity.this,VetementDetailsActivity.class);
                                    ...
                                    cartListRef.child("User View")
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    {
                                                        Toast.makeText(CartVetActivity.this,"\n" + "Élément supprimé avec succès",Toast.LENGTH_SHORT).show();
                                                        Intent intent = new Intent(CartVetActivity.this,home.class);
                                                        startActivity(intent);
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                if (datasnapshot.exists())
                {
                    ...
                    if (shippingState.equals("expédiée"))
                    {
                        ...
                        Toast.makeText(CartVetActivity.this," vous pouvez acheter plus de produits quand vous avez reçu votre première commande",Toast.LENGTH_SHORT);
